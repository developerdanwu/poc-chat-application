...
module.exports = {
  fontSize: {
    h1: [
      '48px',
      { lineHeight: '48px', letterSpacing: '-1.2%', fontWeight: '800' },
    ],
    h2: [
      '30px',
      { lineHeight: '36px', letterSpacing: '-0.75%', fontWeight: '600' },
    ],
    h3: [
      '24px',
      { lineHeight: '32px', letterSpacing: '-0.6%', fontWeight: '600' },
    ],
    h4: [
      '20px',
      { lineHeight: '28px', letterSpacing: '-0.5%', fontWeight: '600' },
    ],
