              ...
              .map(([date, messages]) => {
                return (
                    <div
                        key={date}
                        className={cn(
                            'relative flex flex-col space-y-4 after:absolute after:top-[10px] after:w-full after:border-t after:border-black after:content-[""]'
                        )}
                    >
                      <div
                          className={cn(
                      ...
                      {/*<div*/}
                      {/*  className={cn(*/}
                      {/*    'divider  text-center text-sm font-semibold before:bg-warm-gray-400 after:top-0 after:bg-warm-gray-400'*/}
                      {/*  )}*/}
                      {/*></div>*/}
