...
import {isBlockActive} from '@/components/richtText/utils';
...
import {Popover as PopoverRoot, PopoverContent,} from '@/components/Popover';
...
import {CommandTooltipWrapper} from '@/components/richtText/EditorMenuBar';
...
export const HoveringEmojiPicker = () => {
    ...
    return (
        <>
            <CommandTooltipWrapper description="Emoji">
                <IconButton
                    type="button"
                    size="sm"
                    variant="ghost"
