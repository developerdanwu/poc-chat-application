...
import {createEditor, type Descendant, type Editor, Element, type Node, type NodeEntry,} from 'slate';
import {withHistory} from 'slate-history';
import Leaf from '@/components/richtText/Leaf';
import {SetNodeToDecorations} from '@/components/richtText/blocks/codeBlock';
