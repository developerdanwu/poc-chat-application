...
import BaseRichTextEditor from '@/components/richtText/BaseRichTextEditor';
import {HoveringEmojiPicker, HoveringPeekMessage,} from '@/components/richtText/EditorFooterMenu';
import {useApiTransformUtils} from '@/lib/utils';
import {resetEditor, slateJSONToPlainText, toggleBlock, toggleMark,} from '@/components/richtText/utils';
...
import EditorMenuBar from '@/components/richtText/EditorMenuBar';
        ...
        <div className="z-50 flex h-full min-h-fit">
            <Controller
                ...
                render={({field: {value, onChange}}) => {
                    return (
                        <div
                            className="flex h-auto  min-h-fit w-full flex-col space-y-2 rounded-md border border-slate-300 p-3">
                            <BaseRichTextEditor
